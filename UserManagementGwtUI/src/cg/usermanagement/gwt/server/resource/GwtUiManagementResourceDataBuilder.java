...
public class GwtUiManagementResourceDataBuilder
{
  /*
  ...
  public static Map< String, String > getSupportedLocalesData()
  {
    ...
    Set<Locale> supportedLocales = GwtUiManagementResourceUtil.getSupportedLocales();
    if( supportedLocales == null || supportedLocales.size() == 0 )
      return localesData;
    for( Locale locale : supportedLocales )
    {
      localesData.put( LocaleUtil.getLocaleName( locale ), GwtUiManagementResourceUtil.getResource( GwtUiManagementResourceKey.localename, locale ) );
    }
    return localesData;
  }
